...
//        Address address = LegacyAddress.fromP2SHScript(params, p2shScript);
        Address address = null;
        for (ECKey ecKey : ecKeyList){


            this.redeemScript = ScriptBuilder.createOutputScript(ecKey);
             address = LegacyAddress.fromKey(params, ecKey);
        }
